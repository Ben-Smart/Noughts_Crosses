...
n_games = 5000; % number of training games
...
%     st = State(p1, p2);
    ...
    board.isEnd = false;
    player1 = init_player(player1, p1,0.4);
    player2 = init_player(player2, p2,0.4);
    load("policy_p1")
    player1.states_value = policy_p1;   
    load("policy_p2")
    player2.states_value = policy_p2;
    disp("training...")
    board = play(board,player1,player2,n_games);
    ...
    board.isEnd = false;
    disp("training against Human...")
    board = play_train_human(board,player1,player2,5);
...
%         else:
%             self.p1.feedReward(0.1) #why does player 1 get a lower reward for a draw?
